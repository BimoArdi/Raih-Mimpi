...
//	@RequestMapping(value="/dashboard-update-proyek", method=RequestMethod.POST)
//	public String formInsertProyek (@ModelAttribute("penggunaAktif")Login login,
//			@ModelAttribute("progresProyek")ProgresProyek ppro,
//			@RequestParam("proyek")Proyek proyek,
//			@ModelAttribute("video")Video v, @RequestParam("foto")MultipartFile foto ) {
//		ppro.setProyek(proyek);
//		pps.saveOrUpdate(ppro);
//		v.setProyek(proyek);
//		v.setProgresProyek(ppro);
...
//		f.setProyek(proyek);
//		try {
//			byte[] picInBytes = foto.getBytes();
//			f.setFoto(picInBytes);
//			f.setNamaFoto(foto.getOriginalFilename());
//		}catch(IOException e) {
//			e.printStackTrace();
//		}
//		fs.saveOrUpdate(f);
...
//	}
	...
	public String proyekUpdate(ModelMap mm, @ModelAttribute("pp")ProgresProyek pp) {
		List<Kategori> k = ks.getAll();
